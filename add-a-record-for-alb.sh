...
# Dynamically find the Hosted Zone ID for the given ALB address
...
# Prepare the JSON for Route 53 ChangeBatch
...
if [ $? -eq 0 ]; then
    echo "Successfully updated Route 53 record for ${DOMAIN_NAME} to point to the ALB."
else
